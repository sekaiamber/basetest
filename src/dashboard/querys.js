...
const QUERYS = {
  ...
  GAME_UPGRADE_ITEM: id => `/api/v1/games/items/${id}/upgrade.json`,
  ...
  GAME_AUCTION: '/api/v1/games/items/auction_index.json',
  GAME_MY_AUCTION: '/api/v1/games/items/auction_my.json',
  GAME_AUCTION_SELL_ITEM: id => `/api/v1/games/items/${id}/auction_sell.json`,
  GAME_AUCTION_CLOSE_ITEM: id => `/api/v1/games/items/${id}/auction_close.json`,
  GAME_AUCTION_BUY_ITEM: id => `/api/v1/games/items/${id}/auction_buy.json`,
};
